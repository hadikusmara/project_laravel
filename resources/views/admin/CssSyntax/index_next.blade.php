...
<body>
	...
	<div id='breadcrumb'>
		<ul>
			...
			<li><a href="{{ route('CssSyntax') }}">Sebelumnya CSS</a></li>

		</ul>
	</div>
	<img src="http://127.0.0.1:8000/asset/img/logo.png" alt="Trulli" width="50" height="50">
	<div class="trytopnav">
...
<body>
<center><img src="http://127.0.0.1:8000/asset/img/logo.png" height='50'></center>
<p>Hello World!</p>
