...
<p>If you want to create your own website and save your code online, try our 
<strong>free website builder</strong>, called <a href="/spaces/" target="_blank" onclick="ga('send', 'event', 'spacesFromHowtoStaticWeb', 'click');"><strong>W3schools Spaces</strong></a>:</p>
<div class="w3-center ws-black" style="color:white;margin-left:-32px;margin-right:-32px">
  <div style="opacity:0.96;margin:auto;padding:70px 20px;">
    ...
    <a href="/spaces/" target="_blank" class="ws-btn" style="border-radius:25px;font-size:20px;width:250px;padding: 11px 14px;margin-bottom:15px" title="Get Started With W3Schools Spaces" onclick="ga('send', 'event', 'spacesFromHowtoStaticWeb', 'click');">Get Started for Free</a><br>
    <br>
